...
export const success = (state, action) => {
    ...
    return state.merge({ fetching: false, loading: false, error: null, ...payload });
};

// failed to get the avatar
export const failure = (state) =>
    state.merge({ fetching: false, loading: false,  error: true, payload: null });
